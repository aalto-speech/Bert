...
def main(_):
    ...
    bert_config = model_1.BertConfig.from_json_file('bert_config_0607_small.json')
    input_files = []
    ...
    run_config = tf.contrib.tpu.RunConfig(
        ...
        master=None,
        model_dir='outputckpoints_0607_small',
    ...
    output_eval_file = os.path.join('outputckpoints_0607_small', "eval_results.txt")
