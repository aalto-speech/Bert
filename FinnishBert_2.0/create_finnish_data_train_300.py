...
def main(_):
    data_train=load_vocab('data/kielipankki.train')
    ...
    write_instance_to_example_files(instances,300,max_predictions_per_seq,['data/kielipankki_clean_train_300_final0607.tfrecord'],vocab_words)
