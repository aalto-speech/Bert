...
all_ids=[]
alt_ids=[]
with open('Segment1/yle_nbest_1000_pre_segai', "r", encoding="utf-8") as reader:
    while True:
...
with open('outputckpoints_0907/Segment1/yle_nbest_1000_pre_segai', "r", encoding="utf-8") as reader:
    while True:
        line = reader.readline()
        if not line:
            break
