...
def main(_):
    ...
    bert_config = model_1.BertConfig.from_json_file('bert_config_1306.json')
    input_files = []
    ...
    result = estimator.evaluate(
        input_fn=eval_input_fn, steps=200)

    output_eval_file = os.path.join('outputckpoints_1306', "eval_results_dev.txt")
