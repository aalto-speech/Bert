...
def main(_):
    ...
    if FLAGS.do_train:
        ...
        train_input_fn = input_fn_builder(
            ...
            is_training=True,
            hvd=None )
        estimator.train(input_fn=train_input_fn, hooks=training_hooks, max_steps=200000)
    ...
    output_eval_file = os.path.join('outputckpoints_2', "eval_results.txt")
