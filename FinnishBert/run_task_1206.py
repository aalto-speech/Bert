...
def main(_):
    ...
    bert_config = model_1.BertConfig.from_json_file('bert_config_1206.json')
    input_files = []
    ...
    output_eval_file = os.path.join('outputckpoints_1206', "eval_results.txt")
