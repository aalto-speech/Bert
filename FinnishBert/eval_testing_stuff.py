    ...
    if mode == tf.estimator.ModeKeys.TRAIN:
      ...
      def metric_fn(masked_lm_example_loss, masked_lm_log_probs, masked_lm_ids,
        ...
        return {
            ...
            "masked_log_prob": masked_lm_log_probs
...
def main(_):
    ...
    input_files = []
    input_files.extend(tf.gfile.Glob('kielipankki_clean_dev_300_final.tfrecord'))
    ...
    output_eval_file = os.path.join('outputckpoints_1506', "eval_test.txt")
