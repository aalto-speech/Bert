...
def main(_):
    ...
    bert_config = model_1.BertConfig.from_json_file('bert_config_10032020.json')
    input_files = []
    ...
    run_config = tf.estimator.RunConfig(
        model_dir='outputckpoints_10032020',
    ...
    output_eval_file = os.path.join('outputckpoints_10032020', "eval_results.txt")
