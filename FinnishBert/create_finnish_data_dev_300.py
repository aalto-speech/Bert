...
def main(_):
    data_train=load_vocab('data/kielipankki_clean.dev')
    ...
    write_instance_to_example_files(instances,300,max_predictions_per_seq,['kielipankki_clean_dev_300_final.tfrecord'],vocab_words)
