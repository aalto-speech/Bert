...
def main(_):
    ...
    bert_config = model_1.BertConfig.from_json_file('bert_config_0207.json')
    input_files = []
    ...
    output_eval_file = os.path.join('outputckpoints_0207', "eval_results.txt")
